...
(function () {
  ...
  var MASTER = [
    ...
    { id: 'cris_c',   name: 'Cris Carcel',     role: 'SM',           area: 'Ops',          dept: 'Ops',          section: 'Senior Managers' },
    // Managers
    ...
    { id: 'javi_s',   name: 'Javi Sánchez',    role: 'MGR',          area: 'Shopping+Biz', dept: 'Shopping+Biz', section: 'Managers'        },
    ...
    { id: 'ane',      name: 'Ane Pazos',       role: 'MGR',          area: 'Support',      dept: 'Support',      section: 'Managers'        },
    { id: 'ricardo',  name: 'Ricardo Sosa',    role: 'MGR',          area: 'Support',      dept: 'Support',      section: 'Managers'        },
    { id: 'javi_q',   name: 'Javi Quiros',     role: 'MGR',          area: 'Support',      dept: 'Support',      section: 'Managers'        },
    { id: 'cris_u',   name: 'Cris Usón',       role: 'MGR',          area: 'Ops',          dept: 'Ops',          section: 'Managers'        },
